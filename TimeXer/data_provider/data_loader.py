...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.features == 'M' or self.features == 'MS':
            ...
            # Identify target columns (all non-date, non-exog columns)
    ...
    def inverse_transform_y(self, data):
        ...
        if not hasattr(self, 'target_indices'):
            return self.inverse_transform(data)
        means = self.scaler.mean_[self.target_indices]
        scales = self.scaler.scale_[self.target_indices]
